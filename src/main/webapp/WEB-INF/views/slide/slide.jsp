...
<html>
	...
	<!-- 添加或者修改的模态框    bs-example-modal-lg -->
	<div class="modal fade " id="saveModel">
				...
				<form action="/system/slide/save" method="post" class="form-horizontal" id="saveForm" enctype="multipart/form-data">
					<input type="hidden" name="id">
		                ...
		                <div class="form-group row">
		                  	<label for="title" class="control-label col-md-3">轮播图</label>
		                  	<div class="col-md-9">
		                   	 	<input class="form-control" type="file" name="photo"> <!-- photo与后台控制器的复杂文本变量名一致 -->
		                  	</div>
		                </div>
		...
		<!-- 引入自行编写的slide页面的js代码 -->
		<script type="text/javascript" src="/static/system/js/slide.js"></script>
